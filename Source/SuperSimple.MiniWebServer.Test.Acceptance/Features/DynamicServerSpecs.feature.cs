...
#line hidden
        ...
        [Xunit.TraitAttribute("Category", "Acceptance.Dynamic")]
        [Xunit.InlineDataAttribute("OK", new string[0])]
        [Xunit.InlineDataAttribute("Created", new string[0])]
        [Xunit.InlineDataAttribute("Accepted", new string[0])]
        [Xunit.InlineDataAttribute("BadRequest", new string[0])]
        [Xunit.InlineDataAttribute("Unauthorized", new string[0])]
        [Xunit.InlineDataAttribute("NotFound", new string[0])]
        [Xunit.InlineDataAttribute("MethodNotAllowed", new string[0])]
        [Xunit.InlineDataAttribute("InternalServerError", new string[0])]
        [Xunit.InlineDataAttribute("NotImplemented", new string[0])]
        [Xunit.InlineDataAttribute("BadGateway", new string[0])]
