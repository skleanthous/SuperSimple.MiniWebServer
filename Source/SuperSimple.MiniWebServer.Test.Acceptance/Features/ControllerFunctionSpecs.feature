...
@Acceptance.ControllerFunction
Scenario: Controller function returns HttpContent old version
	Given a controller function on GET - /MyResource/ResourceId that returns HttpContent as object
	| Name   | Value |
	| MyName | 5     |
	When I attempt a get on resource /MyResource/ResourceId
	Then the reply should return
...
@Acceptance.ControllerFunction
Scenario: Controller function returns HttpContent and status code
	Given a controller function on GET - /MyResource/ResourceId that returns as HttpContent with status code 203
	| Name   | Value |
	| MyName | 5     |
	When I attempt a get on resource /MyResource/ResourceId
	Then the reply should have a status code of 203
	And the reply should return
	| Name   | Value |
	| MyName | 5     |
